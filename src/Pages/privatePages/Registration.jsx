...
const BloodDonationRegistration = () => {
    ...
    const validateForm = () => {
        const { name, email, bloodGroup, district,thumbnailUrl, upazila, password, confirmPassword } = formData;
    ...
    const handleSubmit = (e) => {
        ...
        const { name, email, avatarUrl, bloodGroup, thumbnailUrl, district, upazila, role, status } = formData;
            ...
            <div className="py-12 text-black">
                <motion.div
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        {/* Avatar */}
                        <div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 1, delay: 0.8 }}>
