    ...
    return (
        <div className="bg-gradient-to-r from-indigo-100 via-purple-200 to-indigo-100 dark:from-gray-800 dark:via-gray-900 dark:to-black min-h-screen flex flex-col items-center py-16">
            ...
            <motion.div className="text-center mb-12" initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 1 }}>
                <motion.h1 className="text-5xl font-extrabold text-indigo-700 dark:text-white" initial={{ y: -50, opacity: 0 }} animate={{ y: 0, opacity: 1 }} transition={{ duration: 0.8 }}>
                    Welcome Back!
                </motion.h1>
                <motion.p className="py-6 text-lg text-gray-700 dark:text-gray-300" initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.5, duration: 1 }}>
                ...
                <motion.p className="text-sm pb-10 text-gray-600 dark:text-gray-400" initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 1, duration: 1 }}>
                    Don’t have an account yet?{' '}
                    <span className="text-indigo-600 dark:text-indigo-400">
                        <Link to="/signUp">Sign up now</Link>
                    </span>{' '}
                    to join our community. Or back to{' '}
                    <span className="text-indigo-600 dark:text-indigo-400">
                        <Link to="/">Home</Link>
                    </span>
                </motion.p>
            ...
            {/* Login Form Section */}
            <motion.div className="card bg-white dark:bg-gray-800 w-full max-w-sm shadow-2xl rounded-xl mx-auto p-8" initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 1, delay: 1.2 }}>
                {errorMessage && (
                ...
                <form onSubmit={handleLogInBtn} className="space-y-6 relative">
                    {/* Email Input */}
                    <motion.div className="form-control" initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 1.5, duration: 0.8 }}>
                        ...
                        <input
                            ...
                            className="input input-bordered w-full rounded-lg bg-white border-gray-300 focus:ring-2 focus:ring-indigo-500 focus:outline-none py-2 px-4 dark:bg-gray-700 dark:text-white dark:border-gray-600"
                            required
                        />
                    </motion.div>

                    {/* Password Input */}
                    <motion.div className="form-control" initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 1.7, duration: 0.8 }}>
                        <label className="label">
                    ...
                    {/* Login Button */}
                    <motion.div className="form-control mt-6" initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 2, duration: 0.8 }}>
                ...
                <motion.button
                    ...
                    className="btn btn-xs absolute right-10 bottom-[225px] text-indigo-600 dark:text-indigo-400"
                    initial={{ opacity: 0 }}
                    animate={{ opacity: 1 }}
