...
const SearchPage = () => {
    ...
    return (
        <div className="min-h-screen bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100 p-5">
            <div className="max-w-4xl mx-auto">
                <h1 className="text-3xl font-bold mb-5 text-center">Search Donors</h1>

                {/* Search Form */}
                <form onSubmit={handleSearch} className="space-y-4 bg-white dark:bg-gray-800 shadow-lg rounded-lg p-6">
                    <div>
                        ...
                        <select
                            ...
                            className="w-full p-3 bg-white border rounded-lg focus:outline-none focus:ring focus:ring-blue-300 dark:bg-gray-700 dark:text-gray-300 dark:border-gray-600"
                        >
                    ...
                    <div>
                        ...
                        <select
                            ...
                            className="w-full p-3 border bg-white rounded-lg focus:outline-none focus:ring focus:ring-blue-300 dark:bg-gray-700 dark:text-gray-300 dark:border-gray-600"
                        >
