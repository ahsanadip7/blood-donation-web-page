        ...
        <div className="p-5">
            ...
            <div className="border rounded-lg shadow-lg p-5 bg-white">
                ...
                <button
                    ...
                    className="bg-green-600 text-white font-semibold py-2 px-4 rounded-lg hover:bg-green-700 mt-4"
                >
                    Donate
                </button>
            </div>
            ...
            {showModal && (
                <div className="fixed inset-0 bg-gray-800 bg-opacity-75 flex justify-center items-center">
                    <div className="bg-white p-6 rounded-lg shadow-lg w-96">
                        ...
                        <form>
                            <div className="mb-4">
                                <label className="block text-lg font-semibold mb-1">Donor Name</label>
                                <input
                                    type="text"
                            ...
                            <div className="mb-4">
                                <label className="block text-lg font-semibold mb-1">Donor Email</label>
                                <input
                                    type="email"
                        ...
                        <button
                            ...
                            className="mt-4 w-full bg-red-600 text-white font-semibold py-2 px-4 rounded-lg hover:bg-red-700"
                        >
                            Cancel
                        </button>
                    </div>
